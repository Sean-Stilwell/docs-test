...
// node_modules/@gcds-core/components/dist/esm/gcds-alert_38.entry.js
var I18N$o = {
  en: {
    label: {
...
var GcdsAlert = class {
  ...
  render() {
    ...
    return h(Host, { key: "9ca55e2b6562e7dfda9e367b21b5d2aa3bbe37d7" }, isOpen ? h("div", { class: `gcds-alert alert--role-${alertRole} ${isFixed ? "alert--is-fixed" : ""}`, role: "alert", "aria-label": alertRole === "danger" ? I18N$o[lang].label.danger : alertRole === "info" ? I18N$o[lang].label.info : alertRole === "success" ? I18N$o[lang].label.success : alertRole === "warning" ? I18N$o[lang].label.warning : null }, h("gcds-container", { size: isFixed ? container : "full", alignment: "center" }, h("div", { class: "alert__container" }, !hideRoleIcon && h("gcds-icon", { "aria-hidden": "true", class: "alert__icon", size: "h5", "margin-right": "175", name: alertRole === "danger" ? "exclamation-circle" : alertRole === "info" ? "info-circle" : alertRole === "success" ? "checkmark-circle" : alertRole === "warning" ? "warning-triangle" : null }), h("div", { class: "alert__content" }, h("p", { class: "alert__heading" }, h("strong", null, heading)), h("slot", null)), !hideCloseBtn && h("button", { class: "alert__close-btn", onClick: (e) => {
...
var gcdsBreadcrumbsCss = "@layer reset, default;@layer reset{:host{display:block}:host .gcds-breadcrumbs ol{list-style:none;overflow-x:hidden}}@layer default{:host .gcds-breadcrumbs ol{margin:var(--gcds-breadcrumbs-margin);padding:var(--gcds-breadcrumbs-padding)}:host .gcds-breadcrumbs ol.has-canada-link gcds-breadcrumbs-item:first-child:before,:host .gcds-breadcrumbs ol:not(.has-canada-link) ::slotted(:first-child):before{display:none}:host .gcds-breadcrumbs ol.has-canada-link gcds-breadcrumbs-item:first-child:before{display:none}}";
var GcdsBreadcrumbs = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
...
var GcdsBreadcrumbsItem = class {
  ...
  render() {
    const { href } = this;
    return h(Host, { key: "95b1e4dcb1f26c4bbecaed7084c46f7440a939c9", role: "listitem", class: "gcds-breadcrumbs-item" }, h("gcds-link", { key: "c60332192cfe17f487017acbd89a49adbc288e19", size: "regular", href }, h("slot", { key: "34993248082e9a129d2753695db93a7b5ac771f1" })));
  }
  get el() {
    return getElement(this);
  }
...
var GcdsButton = class {
  constructor(hostRef) {
    ...
    this.handleClick = (e) => {
      const emitValue = this.type === "submit" ? this.value : this.type === "link" ? this.href : void 0;
...
function combineValidators(v1, v2) {
  return {
    validate: (x) => {
      ...
      if (typeof res1 === "object" && !res1.valid || typeof res1 === "boolean" && !res1) {
        return typeof res1 === "object" ? res1 : { valid: res1, reason: v1.errorMessage };
      } else if (typeof res2 === "object" && !res2.valid || typeof res2 === "boolean" && !res2) {
        return typeof res2 === "object" ? res2 : { valid: res2, reason: v2.errorMessage };
      } else {
        return {
          valid: true,
          reason: {
...
var requiredEmailField = {
  validate: (value) => {
    return {
      valid: value != null && value.trim() != "" && (value.toLowerCase().match(emailPattern) ? true : false),
      reason: {
...
var getDateInputError = (dateValues, format) => {
...
(function(ValidatorsName2) {
  ...
  ValidatorsName2["requiredRadio"] = "requiredRadio";
  ValidatorsName2["requiredCheckboxGroup"] = "requiredCheckboxGroup";
  ValidatorsName2["requiredCheckboxSingle"] = "requiredCheckboxSingle";
...
function isCheckboxObject(obj) {
  ...
  const hasValidTypes = typeof obj.id === "string" && typeof obj.label === "string" && (obj.value === void 0 || typeof obj.value === "string") && (obj.hint === void 0 || typeof obj.hint === "string") && (obj.checked === void 0 || typeof obj.checked === "boolean");
...
function cleanUpValues(optionsArr, element) {
  ...
  optionsArr.forEach((checkbox) => {
    ...
    if ((checkbox.checked == "true" || checkbox.checked === true) && !element.value.includes(checkbox.value || "on")) {
      element.value = [
        ...element.value,
  ...
  element.value.filter((value) => !availableValues.includes(value)).forEach((value) => {
    element.value = element.value.filter((item) => item !== value);
  });
}
var renderCheckbox = (checkbox, element, emitEvent2, handleInput) => {
  ...
  return h(
    ...
    h("input", Object.assign({ type: "checkbox" }, attrsInput, { onBlur: isGroup ? () => gcdsBlur.emit() : onBlurValidate, onFocus: () => gcdsFocus.emit(), onChange: (e) => handleInput(e, gcdsChange), onInput: (e) => handleInput(e, gcdsInput), onClick: (e) => !disabled ? emitEvent2(e, gcdsClick) : e.stopImmediatePropagation(), ref: (el) => element.shadowElement = [...element.shadowElement || [], el] })),
...
var GcdsCheckboxes = class {
    ...
    this.handleInput = (e, customEvent) => {
      ...
      if (isInputEvent) {
        ...
        if (target.checked) {
          ...
          this.options = (typeof this.options === "string" ? JSON.parse(this.options) : this.options).map((check) => check.value === target.value ? Object.assign(Object.assign({}, check), { checked: false }) : check);
  ...
  async componentWillLoad() {
    ...
    if (!this.isGroup && this.optionsArr && ((_a = this.optionsArr[0]) === null || _a === void 0 ? void 0 : _a.hint) && !this.hint) {
...
var GcdsDateInput = class {
  ...
  async validate() {
    var _a, _b, _c, _d;
    this.hasError = handleValidationResult(this.el, this._validator.validate(this.format === "full" ? `${this.yearValue}-${this.monthValue}-${this.dayValue}` : `${this.yearValue}-${this.monthValue}`), this.legend, this.gcdsError, this.gcdsValid, this.lang, { day: false, month: false, year: false });
  ...
  render() {
    ...
    const month = h("gcds-select", Object.assign({ key: "e6f090b288f964719d989890c1757af3a5339551", label: I18N$j[lang].month, selectId: "month", name: "month", defaultValue: I18N$j[lang].selectmonth, disabled, onInput: (e) => this.handleInput(e, "month"), onChange: (e) => this.handleInput(e, "month"), value: this.monthValue, class: `gcds-date-input__month ${hasError["month"] ? "gcds-date-input--error" : ""}` }, requiredAttr, { "aria-invalid": hasError["month"].toString(), "aria-description": hasError["month"] && errorMessage, form, ref: (el) => this.monthSelect = el }), options.map((option) => h("option", { key: option, value: option }, I18N$j[lang]["months"][option])));
    const year = h("gcds-input", Object.assign({ key: "ed5b22815eaee48211a8feb25cf9198a4b601c9e", name: "year", label: I18N$j[lang].year, inputId: "year", type: "text", inputmode: "numeric", size: 4, disabled, value: this.yearValue, onInput: (e) => this.handleInput(e, "year"), onChange: (e) => this.handleInput(e, "year"), onKeyDown: this.blockInvalidKeys, class: `gcds-date-input__year ${hasError["year"] ? "gcds-date-input--error" : ""}`, "validate-on": "other" }, requiredAttr, { "aria-invalid": hasError["year"].toString(), "aria-description": hasError["year"] && errorMessage, form, ref: (el) => this.yearInput = el }));
    const day = h("gcds-input", Object.assign({ key: "6d79af7da5be2ade8ea8f962c15233294e6042e7", name: "day", label: I18N$j[lang].day, inputId: "day", type: "text", inputmode: "numeric", size: 2, disabled, value: this.dayValue, onInput: (e) => this.handleInput(e, "day"), onChange: (e) => this.handleInput(e, "day"), onKeyDown: this.blockInvalidKeys, "validate-on": "other", class: `gcds-date-input__day ${hasError["day"] ? "gcds-date-input--error" : ""}` }, requiredAttr, { "aria-invalid": hasError["day"].toString(), "aria-description": hasError["day"] && errorMessage, form, ref: (el) => this.dayInput = el }));
    return h(Host, { key: "bd299bd117299d1b0500413185a10a32501b7490", name, onBlur: () => this.onBlur() }, this.validateRequiredProps() && h("fieldset", Object.assign({ key: "02d4a393d8336c29d060716f5ddd9c3e1eb4c46d", class: "gcds-date-input__fieldset" }, fieldsetAttrs, { ref: (el) => this.fieldset = el }), h("legend", { key: "deb09ce61953147d78b00eb1ac45a821651ec80f", id: "date-input-legend" }, legend, required ? h("span", { class: "legend__required" }, I18N$j[lang].required) : null), hint ? h("gcds-hint", { id: "date-input-hint", "hint-id": "date-input" }, hint) : null, errorMessage ? h("div", null, h("gcds-error-message", { id: "date-input-error", messageId: "date-input" }, errorMessage)) : null, format == "compact" ? [month, year] : lang == "en" ? [month, day, year] : [day, month, year]));
  }
  static get delegatesFocus() {
    return true;
  }
...
var gcdsErrorMessageCss = "@layer reset, default;@layer reset{:host{display:inline-block}:host slot{display:initial}}@layer default{:host .error-message gcds-icon,:host .error-message::part(text){color:var(--gcds-error-message-text-color)}}";
var GcdsErrorMessage = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
  }
  render() {
...
var gcdsErrorSummaryCss = "@layer reset, default, compact;@layer reset{:host{display:block}}@layer default{:host{container:component summary/inline-size}:host .gcds-error-summary{border:var(--gcds-error-summary-border-width) solid var(--gcds-error-summary-border-color);color:var(--gcds-error-summary-text);display:none;margin:var(--gcds-error-summary-margin);padding:var(--gcds-error-summary-padding);transition:background .15s ease-in-out,border .15s ease-in-out,color .15s ease-in-out}:host .gcds-error-summary.gcds-show{display:block}:host .gcds-error-summary .summary__errorlist{margin:var(--gcds-error-summary-list-margin);padding:0}:host .gcds-error-summary .summary__errorlist .summary__listitem{max-width:var(--gcds-error-summary-max-width)}:host .gcds-error-summary .summary__errorlist .summary__listitem:not(:last-child){padding:var(--gcds-error-summary-list-item-padding)}:host .gcds-error-summary .summary__errorlist .summary__listitem gcds-link::part(link):not(:focus){color:var(--gcds-error-summary-link-color)}}@layer compact{@container summary (width < 24em){:host .gcds-error-summary{padding:var(--gcds-error-summary-mobile-padding)}}}";
var GcdsErrorSummary = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.gcdsFocus = createEvent(this, "gcdsFocus");
    this.gcdsBlur = createEvent(this, "gcdsBlur");
  ...
  render() {
    ...
    return h(Host, { key: "a42f126a2bbbe41621a5c56d04c87b31e87d0363" }, h("div", { key: "eeee2e16453b3c7911042cabb079ab072d3bcd09", role: "alert", tabindex: "-1", ref: (element) => this.shadowElement = element, class: `gcds-error-summary ${(hasSubmitted || errorLinks) && Object.keys(errorQueue).length > 0 ? "gcds-show" : ""}` }, h("gcds-heading", { key: "5c0aa122bc9f7a1dc250d856734d99befb88502e", tag: "h2", "margin-top": "0", "margin-bottom": "225" }, heading !== null && heading !== void 0 ? heading : I18N$h[lang].heading), h("ol", { key: "2fd12eca1a9ffe4f11aedfdd3b93d3a0becf7420", class: "summary__errorlist" }, (hasSubmitted || errorLinks) && Object.keys(errorQueue).length > 0 && Object.keys(errorQueue).map((key) => {
...
var I18N$g = {
  en: {
    ...
    droppedError: "One or more of the dropped files is unable to be uploaded. Accepted file types:"
  },
  fr: {
    button: {
      remove: "Supprimer",
...
var GcdsGrid = class {
  ...
  validateGapTablet(newValue) {
    const values = GridGapArray;
    if (newValue != void 0 && !values.includes(newValue)) {
  ...
  render() {
    ...
    return h(Host, null, container ? h("gcds-container", { size: container, alignment }, h(Tag, { class: classNames, style: handleGridStyles() }, h("slot", null))) : h(Tag, { class: classNames, style: handleGridStyles() }, h("slot", null)));
  }
  get el() {
    return getElement(this);
  }
...
var GcdsHeading = class {
  ...
  validateMarginTop(newValue) {
    if (!this.marginTop || this.marginTop && !SpacingArray.includes(newValue)) {
      this.marginTop = this.tag === "h1" ? "0" : "600";
    }
  }
  validateMarginBottom(newValue) {
    if (this.marginBottom && !SpacingArray.includes(newValue)) {
      this.marginBottom = "300";
    }
  }
  componentWillLoad() {
...
var gcdsHintCss = "@layer reset, default;@layer reset{:host{display:block}:host slot{display:initial}}@layer default{:host .gcds-hint,:host gcds-text::part(text){color:var(--gcds-hint-text)}:host .gcds-hint{margin:var(--gcds-hint-margin)}}";
var GcdsHint = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
  }
...
var GcdsInput = class {
  constructor(hostRef) {
    ...
    this.handleInput = (e, customEvent) => {
      ...
      if (e.type === "change") {
        if (this.suggestionsArr && this.suggestionsArr.some((suggestion) => {
          var _a;
          return val == ((_a = suggestion.value) !== null && _a !== void 0 ? _a : suggestion.label);
        })) {
  ...
  updateValidity(override) {
    ...
    const validityState = override ? Object.assign(Object.assign({}, this.shadowElement.validity), override) : this.shadowElement.validity;
    let validationMessage = null;
  ...
  render() {
    ...
    return h(Host, { key: "8ba9b63b14c8c0e8625f7468be81462d3b719303" }, h("div", { key: "173a744866d8b3f6eb8e9727fa849123fb752933", class: `gcds-input-wrapper ${disabled ? "gcds-disabled" : ""} ${hasError ? "gcds-error" : ""}` }, h("gcds-label", Object.assign({ key: "4cad5a76c5912dfce86c3dd96aef58132483b05e" }, attrsLabel, { "hide-label": hideLabel, "label-for": inputId, lang })), hint ? h("gcds-hint", { "hint-id": inputId }, hint) : null, errorMessage ? h("gcds-error-message", { messageId: inputId }, errorMessage) : null, h("input", Object.assign({ key: "d19dd65df5c7993b6f08d2443b6b9a5b5fa01231" }, attrsInput, { class: hasError ? "gcds-error" : null, id: inputId, name, onBlur: () => this.onBlur(), onFocus: () => this.gcdsFocus.emit(), onInput: (e) => this.handleInput(e, this.gcdsInput), onChange: (e) => this.handleInput(e, this.gcdsChange), "aria-labelledby": `label-for-${inputId}`, "aria-invalid": inheritedAttributes["aria-invalid"] === "true" ? inheritedAttributes["aria-invalid"] : errorMessage ? "true" : "false", size, style: size ? style : null, list: this.suggestionsArr && this.suggestionsArr.length > 0 ? `datalist-for-${inputId}` : null, part: "input", ref: (element) => this.shadowElement = element })), this.suggestionsArr && this.suggestionsArr.length > 0 ? h("datalist", { id: `datalist-for-${inputId}` }, this.suggestionsArr.map((suggestionOption) => {
      var _a;
...
var GcdsNavGroup = class {
  ...
  async focusOutListener(e) {
    if ((e.target === this.el || this.el.contains(e.target)) && !this.el.contains(e.relatedTarget) && this.navStyle.includes("dropdown") && this.open && window.innerWidth >= 1024) {
  ...
  render() {
    ...
    return h(Host, { key: "dc41c8634f5207f3264c193fa4b643a5d7460bcb", role: "listitem", open }, h("button", { key: "993f5335ec64d025e881c8d3149bc2f6507ae919", "aria-haspopup": "true", tabIndex: 0, "aria-expanded": open.toString(), ref: (element) => this.triggerElement = element, class: `gcds-nav-group__trigger gcds-trigger--${this.navStyle}`, onBlur: () => this.gcdsBlur.emit(), onFocus: () => this.gcdsFocus.emit(), onClick: (e) => {
      const event = emitEvent(e, this.gcdsClick);
      if (event) {
        this.toggleNav();
      }
    } }, h("gcds-icon", { key: "78f16f4980aa7aa8b0226b4760763ba41ecc0e2b", name: this.navStyle === "expandable" ? open ? "chevron-down" : "chevron-right" : open ? "chevron-up" : "chevron-down" }), closeTrigger && open ? closeTrigger : openTrigger), h("ul", { key: "349c7a14f3e13ef7344ea40e35ac8c9000f8d390", "aria-label": menuLabel, class: `gcds-nav-group__list gcds-nav--${this.navStyle}` }, h("slot", { key: "73a3ba354f2a90a0cea6edfe9e47b1ad5c85e92d" })));
  }
  get el() {
    return getElement(this);
  }
  ...
  for (const key in url.queryStrings) {
    ...
    if (key.includes("::")) {
      ...
      if (incrementer == "offset") {
        ...
        queryValue = matches ? url.queryStrings[key].replace(`{{${matches[1]}}}`, `${(pageNumber - 1) * Number(matches[1])}`) : (pageNumber - 1) * url.queryStrings[key];
      ...
      if (incrementer == "match") {
        ...
        queryValue = matches ? url.queryStrings[key].replace(`{{${matches[1]}}}`, `${pageNumber * Number(matches[1])}`) : pageNumber * url.queryStrings[key];
...
var GcdsPagination = class {
  ...
  configurePaginationStep(page, end, mobile) {
    const href = this.urlObject ? constructHref(this.urlObject, page, end) : "javascript:void(0)";
    const linkAttrs = {
      "href": href,
      "tabindex": 0,
      "aria-label": !end ? I18N$7[this.lang].pageNumberOf.replace("{#}", page).replace("{total}", this.totalPages).replace("{label}", this.label) : end == "next" ? `${I18N$7[this.lang].nextPage}: ${I18N$7[this.lang].pageNumberOf.replace("{#}", ++page).replace("{total}", this.totalPages).replace("{label}", this.label)}` : `${I18N$7[this.lang].previousPage}: ${I18N$7[this.lang].pageNumberOf.replace("{#}", --page).replace("{total}", this.totalPages).replace("{label}", this.label)}`,
      "onBlur": () => this.gcdsBlur.emit(),
      "onFocus": () => this.gcdsFocus.emit(),
      "onClick": (e) => emitEvent(e, this.gcdsClick, { page, href })
    };
    if (page == this.currentPage && !end) {
      linkAttrs["aria-current"] = "page";
    }
    if (end) {
      return h("li", null, end === "next" ? h("a", Object.assign({}, linkAttrs, { class: !mobile ? "gcds-pagination-end-button" : "gcds-pagination-end-button-mobile" }), h("span", null, I18N$7[this.lang].listNext), h("gcds-icon", { "margin-left": "150", name: "chevron-right" })) : h("a", Object.assign({}, linkAttrs, { class: !mobile ? "gcds-pagination-end-button" : "gcds-pagination-end-button-mobile" }), h("gcds-icon", { "margin-right": "150", name: "chevron-left" }), h("span", null, mobile ? I18N$7[this.lang].previousMobile : I18N$7[this.lang].listPrevious)));
    } else {
  ...
  configureListPagination() {
    ...
    for (let i = 1; i <= this.totalPages; i++) {
      ...
      if (i == this.currentPage || i == 1 || i == this.totalPages || i >= this.currentPage - 2 && i <= this.currentPage + 2 || this.totalPages < 10) {
...
function isRadioObject(obj) {
  ...
  const objKeys = Object.keys(obj);
  const hasValidTypes = typeof obj.id === "string" && typeof obj.label === "string" && typeof obj.value === "string" && (obj.hint === void 0 || typeof obj.hint === "string") && (obj.checked === void 0 || typeof obj.checked === "boolean");
  const hasOnlyValidKeys = objKeys.every((key) => validKeys.includes(key));
  return hasValidTypes && hasOnlyValidKeys;
}
var I18N$6 = {
...
var GcdsRadios = class {
  ...
  render() {
    ...
    if (this.validateRequiredProps()) {
      return h(Host, { key: "3bd16e4a6cc77fc6114f37791a4342baef496716", onBlur: () => this.onBlurValidate() }, h("fieldset", Object.assign({ key: "8c91df0fae62ebcae079551bc5362e1770d2da23", class: "gcds-radios__fieldset" }, fieldsetAttrs), h("legend", { key: "7372c1addc1d1c715b58ca0dd3dcc75fc6c38be4", id: "radios-legend", class: "gcds-radios__legend" }, this.hideLegend ? h("gcds-sr-only", { tag: "span" }, legend, required && h("span", { class: "legend__required" }, I18N$6[lang].required)) : h(Fragment, null, legend, required && h("span", { class: "legend__required" }, I18N$6[lang].required))), hint ? h("gcds-hint", { id: "radios-hint", "hint-id": "radios" }, hint) : null, errorMessage ? h("gcds-error-message", { id: "radios-error", messageId: "radios" }, errorMessage) : null, this.optionsArr && this.optionsArr.map((radio) => {
        const attrsInput = Object.assign({ name, disabled, required, value: radio.value, checked: radio.value === value, title: radioTitle, form }, inheritedAttributes);
        if (radio.hint) {
...
var GcdsSelect = class {
  ...
  render() {
    ...
    return h(Host, { key: "880e20d5e7fb9a84bc4e5e413b405c9fa162a136" }, h("div", { key: "15360120f3b67e2e507583ce7f000ca957440fb0", class: `gcds-select-wrapper ${disabled ? "gcds-disabled" : ""} ${hasError ? "gcds-error" : ""}` }, h("gcds-label", Object.assign({ key: "3330dda4ebfd959ab6d9b1d98a588509fe70416e" }, attrsLabel, { "hide-label": hideLabel, "label-for": selectId, lang })), hint ? h("gcds-hint", { "hint-id": selectId }, hint) : null, errorMessage ? h("gcds-error-message", { messageId: selectId }, errorMessage) : null, h("select", Object.assign({ key: "518196d275c5163e239fc2adcafe0b52c16ac4bf" }, attrsSelect, { id: selectId, onBlur: () => this.onBlur(), onFocus: () => this.gcdsFocus.emit(), onInput: (e) => this.handleInput(e, this.gcdsInput), onChange: (e) => this.handleInput(e, this.gcdsChange), "aria-invalid": inheritedAttributes["aria-invalid"] === "true" ? inheritedAttributes["aria-invalid"] : errorMessage ? "true" : "false", part: "select", ref: (element) => this.shadowElement = element }), defaultValue ? h("option", { value: "", disabled: true, selected: true }, defaultValue) : null, options.map((opt) => {
  ...
  switch (key) {
    ...
    case "Tab":
      if (await nav.getNavSize() == "mobile") {
        if (event.shiftKey) {
          if (currentIndex == queue.length - 1 && activeElement.hasAttribute("open")) {
            event.preventDefault();
...
var GcdsSignature = class {
  ...
  render() {
    ...
    return h(Host, { key: "3c6dc33d52689afe90a217cf6af7d57d5f5832ea" }, type === "signature" ? h(Tag, Object.assign({}, sigAttrs), h("div", { innerHTML: selectSVG }), h("gcds-sr-only", { tag: "span", lang: lang === "en" ? "fr" : "en" }, lang === "en" ? `/ ${I18N$3.fr.gc}` : `/ ${I18N$3.en.gc}`)) : h("div", { class: "gcds-signature", innerHTML: selectSVG }));
  }
  get el() {
    return getElement(this);
  }
...
var gcdsSrOnlyCss = "@layer reset, default;@layer reset{:host slot{display:initial}}@layer default{:host{clip-path:inset(100%);clip:rect(1px,1px,1px,1px);height:1px;overflow:hidden;position:absolute;white-space:nowrap;width:1px}}";
var GcdsSrOnly = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.tag = "p";
  }
...
var gcdsStepperCss = "@layer reset, default;@layer reset{:host{display:block}}@layer default{:host .gcds-stepper .gcds-stepper__steps{display:block;font:var(--gcds-stepper-font-desktop);margin:var(--gcds-stepper-margin-desktop)}@media only screen and (width < 48em){:host .gcds-stepper .gcds-stepper__steps{font:var(--gcds-stepper-font-mobile);margin:var(--gcds-stepper-margin-mobile)}}}";
var GcdsStepper = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.tag = "h2";
    this.errors = [];
  ...
  updateIfValueChanged() {
    if (this.shadowElement.value !== this.lastInputValue) {
      ...
      setTimeout(() => {
        ...
        if (srCount) {
          srCount.textContent = `${I18N$1[this.lang].characters.left}${this.value === void 0 ? this.maxlength : this.maxlength - this.value.length}`;
        }
      }, 1500);
    }
  }
...
export {
  GcdsAlert as gcds_alert,
  GcdsBreadcrumbs as gcds_breadcrumbs,
  GcdsBreadcrumbsItem as gcds_breadcrumbs_item,
  GcdsButton as gcds_button,
  GcdsCard as gcds_card,
  GcdsCheckboxes as gcds_checkboxes,
  GcdsContainer as gcds_container,
  GcdsDateInput as gcds_date_input,
  GcdsDateModified as gcds_date_modified,
  GcdsDetails as gcds_details,
  GcdsErrorMessage as gcds_error_message,
  GcdsErrorSummary as gcds_error_summary,
  GcdsFileUploader as gcds_file_uploader,
  GcdsFooter as gcds_footer,
  GcdsGrid as gcds_grid,
  GcdsGridCol as gcds_grid_col,
  GcdsHeader as gcds_header,
  GcdsHeading as gcds_heading,
  GcdsHint as gcds_hint,
  GcdsIcon as gcds_icon,
  GcdsInput as gcds_input,
  GcdsLabel as gcds_label,
  GcdsLangToggle as gcds_lang_toggle,
  GcdsLink as gcds_link,
  GcdsNavGroup as gcds_nav_group,
  GcdsNavLink as gcds_nav_link,
  GcdsNotice as gcds_notice,
  GcdsPagination as gcds_pagination,
  GcdsRadios as gcds_radios,
  GcdsSearch as gcds_search,
  GcdsSelect as gcds_select,
  GcdsSideNav as gcds_side_nav,
  GcdsSignature as gcds_signature,
  GcdsSrOnly as gcds_sr_only,
  GcdsStepper as gcds_stepper,
  GcdsText as gcds_text,
  GcdsTextarea as gcds_textarea,
  GcdsTopNav as gcds_top_nav
};
//# sourceMappingURL=gcds-alert_38.entry-QUSJIWK2.js.map
